      ...
      <div className={"text-center"}>
        ...
        >
          <Form>
            ...
            <Field id="addressLine" name="addressLine" placeholder="Jane" />
            <br />

            <label htmlFor="addressLine2">Address line 2</label>
            <Field id="addressLine2" name="addressLine2" placeholder="Doe" />
            <br />

            <label htmlFor="addressType">Address type</label>
            <Field id="addressType" name="addressType" placeholder="Doe" />
            <br />
            ...
            <Field id="postalСode" name="postalCode" placeholder="Doe" />
            <br />

            <label htmlFor="state">State</label>
            <Field id="state" name="state" placeholder="Doe" />
            <br />
